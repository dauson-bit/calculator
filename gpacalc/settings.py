"""
Django settings for gpacalc project.
...
SECRET_KEY = 'django-insecure-$4093e5sy6^b332ruqu11yw=jb0eqy2i$7j(j&g(^sm4768n)j'
...
WSGI_APPLICATION = 'gpacalc.wsgi.application'
